...
class ChatView extends GetView<ChatController> {
  ...
  Widget _buildInputArea() {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        // Quick Replies - Courier specific
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          padding: EdgeInsets.symmetric(horizontal: 16, vertical: 12),
          child: Row(
            children: [
              _buildQuickReplyButton("Saya sedang menuju lokasi"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Sudah sampai merchant"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Pesanan sudah diambil"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Sedang menuju alamat Anda"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Estimasi 10 menit lagi"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Saya sudah di depan"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Lokasi sulit ditemukan"),
              SizedBox(width: 8),
              _buildQuickReplyButton("Pesanan sudah diterima"),
              SizedBox(width: 8),
